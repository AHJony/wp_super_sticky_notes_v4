...
var addQtip = function(element){
    ...
    data_id.forEach(function(single_id){           
        ...
        if(notesAjax.notes[single_id] != undefined){
            ...
            var comment_user_like = (typeof notesAjax.notes[single_id].comment_user_like != 'undefined') ? notesAjax.notes[single_id].comment_user_like : '';
            var comment_user_unlike = (typeof notesAjax.notes[single_id].comment_user_unlike != 'undefined') ? notesAjax.notes[single_id].comment_user_unlike : '';
            var comment_admin_like = (typeof notesAjax.notes[single_id].comment_admin_like != 'undefined') ? notesAjax.notes[single_id].comment_admin_like : '';
            var comment_admin_unlike = (typeof notesAjax.notes[single_id].comment_admin_unlike != 'undefined') ? notesAjax.notes[single_id].comment_admin_unlike : '';
            ...
            // var admin_name = (notesAjax.notes[single_id].note_reply_admin_role == 'administrator') ? 'Admin' : 'Teacher';
...
"use strict";
    /*
    * New Comment without page load
    */
   jQuery(document.body).on('click', 'div#stickeyItems a.commentLink', function(e){
        e.preventDefault();
        var href = jQuery(this).attr('href');

        var formdata = {
            'action' : 'newCommentViaAjax' 
        };

        // Retular url: notesAjax.ajax
